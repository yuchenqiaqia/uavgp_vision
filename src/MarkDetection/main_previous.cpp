...
{  
    ...
    image_transport::ImageTransport it(imgPubNode);
    //image_transport::Publisher pub;
    ...
    if (true == saveEnble)
    {
        ...
        outputVideo.open( video_name, CV_FOURCC('D', 'I', 'V', 'X'), 20.0, Size(srcImg.cols, srcImg.rows),true );
        //('M', 'P', '4', '2') = MPEG-4.2 codec,    ('D', 'I', 'V', '3') = MPEG-4.3 codec,   ('D', 'I', 'V', 'X') = MPEG-4 codec,     ('U', '2', '6', '3') = H263 codec,      ('I', '2', '6', '3') = H263I codec,   ('F', 'L', 'V', '1') = FLV1 codec
    }
